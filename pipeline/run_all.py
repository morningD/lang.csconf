...
from pipeline import step1_parse_conferences, step1b_parse_accept_rates, step2_crawl_sparql, step2b_crawl_venues, step3_classify_names, step4_generate_stats
...
def main():
    ...
    parser.add_argument("--step", type=str, help="Run only a specific step (1, 2, 2b, 3, 4)")
