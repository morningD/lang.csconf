...
from pipeline import step1_parse_conferences, step1b_parse_accept_rates, step2_crawl_sparql, step2b_crawl_venues, step2c_fill_gaps, step2d_crawl_openreview, step2e_fetch_affiliations, step3_classify_names, step4_generate_stats
...
def main():
    ...
    steps = [
        ...
        ("2e", "Fetch affiliations (OpenAlex)", lambda: step2e_fetch_affiliations.run(force=args.force, conferences_filter=conferences_filter)),
