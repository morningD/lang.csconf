import { ref } from 'vue'
import type { Meta, GlobalSummary, ConferenceIndex, ConferenceDetail, CategoryStats, RankStats, AffiliationTrendManifest, AffiliationTrendChunk, AffiliationIndex } from '@/types'
